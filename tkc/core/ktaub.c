...
double kendallSmallN( double *arr1, double *arr2, int len )
{
...
#define NSTEP 10
     ...
     */
    {
        ...
        foo = (double *) malloc(NTOP * sizeof(double));
        bar = (double *) malloc(NTOP * sizeof(double));
        buf = (double *) malloc(NTOP * sizeof(double));
